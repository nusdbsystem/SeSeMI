...
// Modified from tvm-0.9.0/apps/bundle_deploy/bundle.h
...
TVM_DLL void tvm_runtime_set_input(void* runtime, const char* name,
                                   DLTensor* tensor);

TVM_DLL void tvm_runtime_run(void* runtime);

TVM_DLL void tvm_runtime_get_output(void* runtime, int32_t index,
                                    DLTensor* tensor);
