...
#ifndef SESEMIWORKER_INFERENCERUNTIME_TFLMDEFAULT_COMMON_ABSTRACT_H_
#define SESEMIWORKER_INFERENCERUNTIME_TFLMDEFAULT_COMMON_ABSTRACT_H_
...
#endif  // SESEMIWORKER_INFERENCERUNTIME_TFLMDEFAULT_COMMON_ABSTRACT_H_
