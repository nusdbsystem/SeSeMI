...
#ifndef SESEMIWORKER_INFERENCERUNTIME_TVMBERT_COMMON_BERTINPUT_H_
#define SESEMIWORKER_INFERENCERUNTIME_TVMBERT_COMMON_BERTINPUT_H_
...
#endif  // SESEMIWORKER_INFERENCERUNTIME_TVMBERT_COMMON_BERTINPUT_H_
