...
## generated model artifacts
COMMON_INCLUDE_FLAGS := -I./src -I$(SESEMI_ROOT) -I$(PROJECT_ROOT_DIR)/include -I$(CRT_SRCS_LOCAL)/include
...
src/trusted/bert_input.o: src/common/bert_input.cpp
...
Enclave_Objects := src/trusted/bert_input.o src/trusted/tvm_default.o  src/trusted/patch.o $(MODEL_OBJ)
