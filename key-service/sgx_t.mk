...
COMMON_INCLUDE_FLAGS = -I. -I${PROJECT_ROOT_DIR}/include -I$(PROJECT_ROOT_DIR)/include/key-service/trusted -I${SESEMI_ROOT}
...
src/trusted/hexutil.o: ${SESEMI_ROOT}/utils/hexutil.cpp
	$(CXX) ${Enclave_Cpp_Flags} -c $< -o $@
	@echo "CXX <= $<"
...
src/trusted/seal.o: ${SESEMI_ROOT}/utils/seal_t.cpp
	$(CXX) ${Enclave_Cpp_Flags} -c $< -o $@
	@echo "CXX <= $<"
...
src/trusted/keyservice_user.o: ${SESEMI_ROOT}/message/keyservice_user.cpp
	$(CXX) ${Enclave_Cpp_Flags} -c $< -o $@
	@echo "CXX <= $<"
